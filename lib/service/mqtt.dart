...
import 'package:app_mqtt_whorkshop/model/getDataModel.dart';
...
class GetDataMqttProvider with ChangeNotifier {
  ...
  Future<void> connect() async {
    client = MqttServerClient.withPort(
        "broker.hivemq.com", "mqttClientId_Mb1_ll", 1883);
    ...
    if (client.connectionStatus!.state == MqttConnectionState.connected) {
      client.subscribe("ceitiot/test/mqtt/dht", MqttQos.atMostOnce);
